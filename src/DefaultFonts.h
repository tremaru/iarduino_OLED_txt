#if defined(__AVR__)							//	Номер байта п/п:		0	1	2	3	4	5							Номер байта п/п:		0	1	2	3	4	5
	#include <avr/pgmspace.h>					//	Значение байта (hex):	00,	20,	54,	54,	54,	78,		буква «а»			Значение байта (hex):	00,	7F,	28,	44,	44,	38		буква «b»
#elif defined(RENESAS_CORTEX_M4)				//	0 бит: (младший)		0	0	0	0	0	0	=	|      |			0 бит: (младший)		0	1	0	0	0	0	=	| #    |
	#include <avr/pgmspace.h>					//	1 бит:					0	0	0	0	0	0	=	|      |			1 бит:					0	1	0	0	0	0	=	| #    |
	#include <stdint.h>							//	2 бит:					0	0	1	1	1	0	=	|  ### |			2 бит:					0	1	0	1	1	0	=	| # ## |
#else											//	3 бит:					0	0	0	0	0	1	=	|     #|			3 бит:					0	1	1	0	0	1	=	| ##  #|
	#include <pgmspace.h>						//	4 бит:					0	0	1	1	1	1	=	|  ####|			4 бит:					0	1	0	0	0	1	=	| #   #|
	#include <stdint.h>							//	5 бит:					0	1	0	0	0	1	=	| #   #|			5 бит:					0	1	1	0	0	1	=	| ##  #|
#endif											//	6 бит:					0	0	1	1	1	1	=	|  ####|			6 бит:					0	1	0	1	1	0	=	| # ## |
