...
// iarduino_OLED myOLED_1(0x3C); // Нужно указать адрес вашего дисплея // Создаём объект myOLED_1, указывая адрес дисплея на первой программной шине I2C.
// iarduino_OLED myOLED_2(0x3C); // Нужно указать адрес вашего дисплея // Создаём объект myOLED_2, указывая адрес дисплея на второй программной шине I2C.
